#!/usr/bin/env bash
# Vendored verbatim from https://github.com/hakuimaku/hakuspace
# (src/home/.local/bin/cava_manager.sh), MIT License, Copyright (c) 2026 Hakuimaku.
# Full license text in ~/Desktop/hakuspace/LICENSE. Local changes: none.
